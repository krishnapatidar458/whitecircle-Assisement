      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Ready to scale your e-commerce business? Let's discuss your growth strategy
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold mb-6">Let's Start Your Growth Journey</h3>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">hello@whitecirclegroup.com</div>
                </div>
              </div>
